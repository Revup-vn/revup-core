const kStorePathUserCollection = 'users';
const kStorePathPayAccountsDocument = 'pay_accounts';
const kStorePathRecordCollection = 'record';
const kStorePathPaymentDocument = 'payment';
